...
![alt OAS logo](https://github.com/SoliDry/laravel-api/tree/master/tests/images/OpenAPI_Logo_Pantone-1.png)
![alt Laravel logo](https://github.com/SoliDry/laravel-api/tree/master/tests/images/laravel-logo-white.png)
![alt JSON API logo](https://github.com/SoliDry/laravel-api/tree/master/tests/images/jsonapi.png) 
...
![Console output](https://github.com/SoliDry/laravel-api/tree/master/tests/images/Console_generator_output.png)

After that u can see the following dirs and files module structure in your project:

![Dirs and files](https://github.com/SoliDry/laravel-api/tree/master/tests/images/Dirs_and_files_module_structure.png)
...
![OAS API docs generated](https://github.com/SoliDry/laravel-api/tree/master/tests/images/API_docs_gen.png)
